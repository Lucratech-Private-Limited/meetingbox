...
export default function MeetingList({ meetings, onStartRecording, onDeleteMeeting }: MeetingListProps) {
  if (meetings.length === 0) {
    return (
      <div className="text-center py-12" data-tutorial="tutorial-meeting-list">
        ...
        <h3 className="mt-2 text-sm font-medium text-app-ink">No meetings found</h3>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" data-tutorial="tutorial-meeting-list">
